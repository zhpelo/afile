...
CREATE TABLE `zpl_captcha` (
  `id` int(10) NOT NULL,
  `event` varchar(30) COLLATE utf8_unicode_ci NOT NULL COMMENT '事件',
  `type` enum('email','mobile') COLLATE utf8_unicode_ci NOT NULL COMMENT '验证类型',
  `addressee` varchar(120) COLLATE utf8_unicode_ci NOT NULL COMMENT '收信人',
...
(22, 0, 0, '3.png', 'bb396b9d9df9613d75f34cfb423ffa90', 'g72tky', 'upload/bb/bb396b9d9df9613d75f34cfb423ffa90', 72189, 'png', 1, '127.0.0.1', 1, 1618378271, 1618378296),
(23, 0, 0, '微信截图_20210413003019.png', '9fe75b19f736d17741e0e9e55755e4ac', 'ohojbE', 'upload/9f/9fe75b19f736d17741e0e9e55755e4ac', 28890, 'png', 1, '127.0.0.1', 1, 1618378907, NULL),
(24, 3, 0, '微信截图_20210413003106.png', 'bb396b9d9df9613d75f34cfb423ffa90', '377', 'upload/bb/bb396b9d9df9613d75f34cfb423ffa90', 72189, 'png', 1, '127.0.0.1', 1, 1618383300, NULL),
(25, 3, 0, '微信截图_20210413003106.png', 'bb396b9d9df9613d75f34cfb423ffa90', 'oH9OU3', 'upload/bb/bb396b9d9df9613d75f34cfb423ffa90', 72189, 'png', 1, '127.0.0.1', 1, 1618416016, NULL),
(26, 3, 0, '250x250.png', '9a145db2de1718e4f7cc260d49b897ce', 'ABdCA0', 'upload/9a/9a145db2de1718e4f7cc260d49b897ce', 49636, 'png', 1, '127.0.0.1', 1, 1618416213, NULL);
...
(3, 3, 2, '1', NULL, 0, 0, NULL, 'active', 1618242684, 1618242684),
(4, 3, 3, '2', NULL, 0, 0, NULL, 'active', 1618242692, 1618242692),
(5, 3, 4, '3', NULL, 0, 0, NULL, 'active', 1618242704, 1618242704);
...
(6, 'alias_string', 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890', '分享码生成规则', 'yes'),
(7, 'alias_length', '6', '分享码长度', 'yes'),
(8, 'mail_smtp_host', 'smtpdm.aliyun.com', 'SMTP服务器', 'yes'),
(9, 'mail_smtp_port', '465', 'SMTP端口', 'yes'),
(10, 'mail_smtp_user', 'user@e.wxrym.com', 'SMTP用户名', 'yes'),
(11, 'mail_smtp_pass', 'QAZqaz123456', 'SMTP密码', 'yes'),
(12, 'mail_verify_type', '', 'SMTP验证方式', 'yes'),
(13, 'mail_from', 'user@e.wxrym.com', '发件人邮箱', 'yes');
...
(5, 0, '&lt;p&gt;这是第一个&lt;/p&gt;', 1, 'B7rnDF', 1, '127.0.0.1', 1618232498, NULL),
(6, 0, '&lt;p&gt;23e234e2ewdwq32e23&lt;/p&gt;', 0, 'RWydnd', 1, '127.0.0.1', 1618238223, 1618843023),
(7, 0, '&lt;p&gt;asdasdggggggggggggggggggg&lt;/p&gt;', 1, 'Tf5pTZ', 1, '127.0.0.1', 1618238350, 1618239840),
(8, 0, '&lt;p&gt;ddddddddddd&lt;/p&gt;', 1, 'QSlRFl', 1, '127.0.0.1', 1618238359, 1618239838),
(9, 0, '&lt;p&gt;1111111&lt;/p&gt;', 1, 'WwkN2p', 1, '127.0.0.1', 1618239413, 1618239831),
(10, 0, '&lt;p&gt;这是一个会永久存储的文字&lt;/p&gt;', 0, 'QPblxY', 1, '127.0.0.1', 1618240520, NULL);
...
--
ALTER TABLE `zpl_file`
  MODIFY `file_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `zpl_text`
  MODIFY `text_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
